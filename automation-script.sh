...
#As we have already created a Docker image by building the Spring-boot project and uploaded
#it to Docker hub, Next step is to deploy k8 resources by retrieving the image from docker hub.
